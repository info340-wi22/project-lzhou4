        ...
        <div className="row restaurant-rank my-5">
            <div className="col-sm-7">
                <img className="food-pic img-fluid"
                    src={props.restraurant.restrImg}
                    alt={props.restraurant.restrName} aria-label={props.restraurant.restrName} />
            </div>
            <div className="col-sm-5">
                <div className="restaurant-summary pt-3 pt-sm-0">
                    <h1 className="d-inline d-sm-block">Top 1:</h1>
                    <h2 className="d-inline d-sm-block">{props.restraurant.restrName}</h2>
                    <p>{props.restraurant.restrDescrp}</p>
                    <a
                        href={props.restraurant.restrDir}>Bring
                        me there!</a>
                </div>
            </div>
        </div>
...
export function RestraurantList(props) {
    ...
    let restrListArray = SAMPLE_RESTRAURANTS.map((elem) => {
